...
<style>
    ...
    .trDiv input[type=text] { border:1px solid #a6a6a6; width:150px; height:25px; }
...
<input type="hidden" name="tr_email" value=""/>
			...
			<div class="trDiv">
				...
				<div class="tdDiv-right">
					<div class="subTit"> 
						...
						<img src="/TripINN/images/table_req.png" alt="" /><b>필수입력 항목</b></span>
						</p>
					...
					<div style="width:48%;height:40px;float:left;">
						...
						<div class="rInfo" style="width:73%;height:100%;float:left;padding-top:5px;">
							<input type="text" name="tr_phone1"  style="width:50px;"/> -
							<input type="text" name="tr_phone2"  style="width:70px;"/> -
							<input type="text" name="tr_phone3"  style="width:70px;"/> 
						</div>
					</div>
					<div style="width:98%;height:40px;float:left;">
						...
						<div class="rInfo" style="width:*;height:100%;float:left;padding-top:5px;">
							<input type="text" name="tr_email1"  /> @ 
							<input type="text" name="tr_email2"  />
	...
	<div class="reserve_layerWindow">
	 ...
	 <div id="reserve_layer">
	 	<h2 style="border-bottom:1px solid black;">예약 확인</h2>
		 <div class="reserve_line">
			...
			<div class="trDiv">
		 	...
		 	<div class="trDiv">
		 		<div class="tdDiv-col">
		 		<a class="btn_reserve" onclick="reserveCheck();">로그인</a>
                    <a href="javascript:r_confirm('close');" title="레이어 닫기" class="close">닫기</a>
		 		</div>
		 	</div>
		 </div>
