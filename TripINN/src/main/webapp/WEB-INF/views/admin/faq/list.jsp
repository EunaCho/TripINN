         ...
         <div class="dataTable_wrapper">
            <div id="dataTables-example_wrapper"
               ...
               <div class="row" style="text-align:left;">
                  <div class="col-sm-6">
                     <a href="/TripINN/admin/faqList.do?searchNum=0&isSearch="><button type="button" class="btn btn-outline btn-default">전체보기</button></a>                                 
                  </div>
                  ...
                  <div class="col-sm-12">
                     <table
                        ...
                        <!--  등록된 FAQ가 없을때 -->
                           ...
                           <br>
                              <tr><td colspan="9" style="text-align:center;"><br><br>등록된 FAQ가 없습니다</td></tr>
                           </c:if> 
                        </tbody>
                     </table>
                  </div>
