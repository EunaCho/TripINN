...
<script src="/TripINN/js/house/slide.js" type="text/javascript"></script>
   ...
   <div id="houseDetail">
      ...
      <div class="houseHead">
               ...
               <div class="subject_middle">
                  ...
                  <div class="subject_name">
                     ...
                     <div style="margin-top: 10px">
                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#Message">메시지 보내기</button>
                     </div>
                  </div>
         ...
         <div class="header_right">
            <!-- 슬라이드 시작 -->
            <div id="jssor_1"
               style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 500px; height: 456px; overflow: hidden; visibility: visible; background-color: #24262e;"   jssor-slider="true">
               <!-- Loading Screen -->
